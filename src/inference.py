...
def run(args):
    ...
    checkpoint_path = f"./checkpoints/{method_name}/all_{embedding_model_abbreviation}_{seed}.ckpt"
    save_path = f'results/{args.dataset.dataset_name}/{embedding_model_name}/{method_name}-{seed}.json'
