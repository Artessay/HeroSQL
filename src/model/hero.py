...
class Hero(nn.Module):
    ...
    def forward(
        ...
        graph_embedding = graph_embedding + sql_embedding  # add sql information to graph
    ...
    def encode_lp_graph(self, graph_batch: Batch):
        ...
        # )
        # project_property_embedding = self.lp_text_projector(property_embedding)
        ...
        # graph_feature = project_property_embedding + node_asts_embedding
        graph_feature = node_asts_embedding
        
        return self.lp_graph_encoder(graph_feature, graph_batch.edge_index, graph_batch.batch)
...
if __name__ == "__main__":
    ...
    _, _, test_loader = create_dataloader("bird", batch_size=3, mode="test", method_name="hero", embedding_model_name=embedding_model_name)
